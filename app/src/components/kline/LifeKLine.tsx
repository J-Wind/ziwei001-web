...
function CustomTooltip({ active, payload }: TooltipProps) {
  ...
  return (
    <div className="bg-night/95 backdrop-blur-md p-2.5 md:p-3.5 rounded-xl shadow-2xl border border-gold/30 z-50 w-[220px] md:w-[260px] min-w-[220px] md:min-w-[260px] max-w-[220px] md:max-w-[260px] box-border">
      {/* ─── Header ─── */}
      <div className="flex justify-between items-center mb-3 md:mb-4 border-b border-gold/20 pb-1.5 md:pb-2">
        <div>
          <p className="text-lg md:text-xl font-bold text-white" style={{ fontFamily: 'var(--font-brush)' }}>
            ...
            <span className="text-xs md:text-sm text-gold ml-1 md:ml-2">({data.age}岁)</span>
          </p>
        </div>
      ...
      {/* ─── OHLC Grid ─── */}
      <div className="grid grid-cols-4 gap-1.5 md:gap-2 mb-2 md:mb-3 p-2.5 md:p-3 bg-white/[0.06] border border-gold/15 rounded-xl">
  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      {!klineCache ? (
        ...
        <>
          {/* ─── K 线图 ─── */}
          <div className="relative p-4 rounded-2xl bg-night/50 backdrop-blur-sm border border-white/[0.1]">
            {/* 顶部发光线 */}
            ...
            <div className="overflow-x-auto md:overflow-x-visible -mx-4 px-4 md:mx-0 md:px-0" style={{ WebkitOverflowScrolling: 'touch' }}>
              ...
              >
                ...
                <Tooltip
                  ...
                  cursor={{ stroke: 'rgba(255,221,85,0.5)', strokeWidth: 1, strokeDasharray: '4 4' }}
                />
          ...
          {selectedPoint && (
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {/* 详细信息卡片 */}
              <div className="p-4 rounded-2xl bg-night/50 backdrop-blur-sm border border-white/[0.1]">
          ...
          {/* ─── 追问功能 ─── */}
          <div className="relative p-6 lg:p-8 bg-night/70 backdrop-blur-md border border-white/[0.1] rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <FollowUpQuestion
...
function EmptyState() {
  return (
    <div className="text-center p-8 rounded-2xl bg-night/50 border border-white/[0.1]">

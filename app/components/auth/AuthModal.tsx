  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          <div className="flex mb-6 rounded-xl overflow-hidden bg-white/[0.03] border border-white/10 p-1">
            <button
              onClick={() => { setAuthModalTab('login'); setError('') }}
              className={`flex-1 py-2.5 text-center text-base font-medium rounded-lg transition-all duration-200 ${
                isLogin ? 'bg-gradient-to-r from-gold to-gold-dark text-night shadow-sm' : 'text-text-muted hover:text-text-secondary'
              }`}

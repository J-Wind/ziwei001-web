...
var require_ganzhi = __commonJS({
  "node_modules/lunar-lite/lib/ganzhi.js"(exports) {
    ...
    var getHeavenlyStemAndEarthlyBranchBySolarDate = function(dateStr, timeIndex, options) {
      ...
      var monthly = [
        (options === null || options === void 0 ? void 0 : options.month) === "normal" ? lunar.getMonthGan() : lunar.getMonthGanExact(),
        (options === null || options === void 0 ? void 0 : options.month) === "normal" ? lunar.getMonthZhi() : lunar.getMonthZhiExact()
      ];
      var daily = [

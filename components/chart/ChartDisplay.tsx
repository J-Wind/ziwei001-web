...
function PalaceCard({
  ...
  return (
    <div
        onClick={onClick}
        className={`
          group relative p-1 xs:p-1.5 sm:p-1.5 md:p-2 lg:p-3 h-full flex flex-col
          bg-white/[0.03] backdrop-blur-sm
          border border-white/[0.06] rounded-md sm:rounded-xl
          transition-all duration-300 cursor-pointer
          hover:bg-white/[0.06] hover:border-white/[0.12]
          ${isLife ? 'ring-1.5 ring-star border-gold/60 bg-gradient-to-br from-white/[0.06] to-white/[0.04]' : ''}
...
function CenterInfo({ chart, solarDate, gender }: CenterInfoProps) {
  ...
  return (
    <div className="
      ...
      backdrop-blur-md border border-white/[0.08] rounded-lg sm:rounded-xl
    ">
      {/* 背景装饰 */}

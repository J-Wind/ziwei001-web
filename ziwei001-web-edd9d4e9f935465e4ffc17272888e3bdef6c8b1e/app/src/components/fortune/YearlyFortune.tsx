...
const MarkdownComponents = {
  ...
  h3: ({ children }: { children?: React.ReactNode }) => (
    <h3 className="text-base sm:text-lg font-medium text-star-dark mt-3 mb-2">{children}</h3>
  ),
  h4: ({ children }: { children?: React.ReactNode }) => (
    <h4 className="text-sm sm:text-base font-medium text-star-dark/80 mt-3 mb-1.5">{children}</h4>
  ),
  ...
  ul: ({ children }: { children?: React.ReactNode }) => (
    <ul className="list-none space-y-1 sm:space-y-1.5 mb-2.5 sm:mb-3 pl-4 xs:pl-5 sm:pl-6">{children}</ul>
  ),
  ...
  li: ({ children }: { children?: React.ReactNode }) => (
    <li className="relative pl-6 xs:pl-7 sm:pl-8 mb-2 leading-relaxed text-sm sm:text-base">
      <span className="absolute left-0 top-[0.35em] text-star/60 text-xs select-none">◆</span>
      {children}
    </li>
  ),
